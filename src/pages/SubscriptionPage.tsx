...
export const SubscriptionPage = () => {
    ...
    const plans = [
        ...
        },
        {
            ...
            features: ['Все функции месячной', 'Скидка 17%', 'Приоритетная поддержка', 'Сертификаты', 'Эксклюзивные курсы'],
            popular: true,
        },
        {
            id: 'lifetime',
        ...
        },
        {
            ...
            features: ['До 3 членов семьи', 'Все функции месячной', 'Семейная статистика', 'Скидка 44%', 'Общий прогресс'],
            popular: false,
        },
    ]
