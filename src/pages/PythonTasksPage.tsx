    ...
    if (showTest) {
        if (testCompleted) {
            ...
            if (score >= 18) {
                ...
                statusAdvice = 'Не переживай — вернись к проектам в разделе "Задачи", пересмотри задания и попробуй ещё раз. Практика поможет тебе закрепить знания и улучшить результаты.'
                statusColor = 'text-warning'
            } else {
                // 0-45% - Не пройден
                statusEmoji = '❌'
